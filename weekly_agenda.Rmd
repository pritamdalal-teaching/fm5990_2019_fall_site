...
#### (05) 10/1 - more `group_by()`, occ volume analysis


<span style="color:gray":>*Material Covered:*</span>

**Topics:** We're going to cover additional material on `group_by()` and `agg()` since it's such an important technique.  Then we'll put together what we've learned so far by completing an option volume analysis.
...
<!-- #### (06) 03/05 - group projects assigned and visualziation -->
...
<!-- #### (08) 03/19 - spring break, no class -->

<!-- &nbsp; -->

<!-- #### (09) 03/26 - additional data analysis topics -->
...
<!-- #### (10) 04/02 - python, ipython, and jupyter -->
