...
**Topics:** We'll start by applying all the skills we've learned so far by completing an analysis of OCC option volumen data.  We also cover the finance material you will need to complete projects. We'll also discuss the project.
